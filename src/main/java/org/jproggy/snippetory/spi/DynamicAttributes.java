...
public interface DynamicAttributes {
	 ...
	 * wil be provided over this method.
	 * <p>
	 * Example:<br />
	 * <pre>
	 *   {v: button='Test' button.id='btn_id' button.onclick='buttonClicked()'}
	 * </pre>
	 * If there is a setter method <code>setId(String val)</code> this will be called
	 * with paramter <code>"btn_id"</code> and <code>setAttribute</code> will
